...
export default function Home({ work }) {
  ...
  const displayedWorks = work
    ...
    .sort((a, b) => b.videoScore - a.videoScore); // videoScore順に並び替え

  return (
    <div>
      <Head>
        <title>おすすめの作品 - EventArchives</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="おすすめの作品  - EventArchives"
        />
        <meta
          property="og:description"
          content="おすすめの作品 です。ぜひご覧ください。"
        />
        <meta
          property="og:image"
